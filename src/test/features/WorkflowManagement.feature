Feature: Orion Finance Finco Test Scenarios
  Background:
    ...
    Then I enter "admin" text to username text area
  ...
  Scenario: PRECONDITION - Creating a job for getting a reference number
    ...
    Then I enter "test" text to main group name text area
    Then I enter "test" text to subgroup name text area
