    ...
    public static void openAndRun(String shType, String host, String user, String password, String msisdn, String offerKey) {
        ...
        try {
            ...
            try {
                switch (shType) {
                    case "checkSMS":
                        addArrayList(bufferedReader, msisdnList, messageList, msisdn);
                    case "nat_voice_80_bundle":
                        addArrayList(bufferedReader, natVoiceBundleMsisdnList, natVoiceBundleList, msisdn);
                    case "nat_data_80_bundle":
                        addArrayList(bufferedReader, natDataBundleMsisdnList, natDataBundleList, msisdn);
                    case "nat_sms_80_bundle":
                        addArrayList(bufferedReader, natSmsBundleMsisdnList, natSmsBundleList, msisdn);
                    case "nat_voice_100_bundle":
                        addArrayList(bufferedReader, natVoice100BundleMsisdnList, natVoice100BundleList, msisdn);
                    case "nat_data_100_bundle":
                        addArrayList(bufferedReader, natData100BundleMsisdnList, natData100BundleList, msisdn);
                    case "nat_sms_100_bundle":
                        addArrayList(bufferedReader, natSms100BundleMsisdnList, natSms100BundleList, msisdn);
                    case "nat_rg1":
                        addArrayList(bufferedReader, natRG1MsisdnList, natRG1List, msisdn);
                    case "nat_rg2":
                        addArrayList(bufferedReader, natRG2MsisdnList, natRG2List, msisdn);
                    case "nat_rg3":
                        addArrayList(bufferedReader, natRG3MsisdnList, natRG3List, msisdn);
                    case "nat_voice_vodafone":
                        addArrayList(bufferedReader, natVoiceVodafoneMsisdnList, natVoiceVodafoneList, msisdn);
                    case "nat_voice_fixed_line":
                        addArrayList(bufferedReader, natVoiceFixedLineMsisdnList, natVoiceFixedLineList, msisdn);
                    case "nat_voice_overusage":
                        addArrayList(bufferedReader, natVoiceOverusageMsisdnList, natVoiceOverusageList, msisdn);
                    case "nat_sms_overusage":
                        addArrayList(bufferedReader, natSmsOverusageMsisdnList, natSmsOverusageList, msisdn);
                    case "nat_data_paradox":
                        addArrayList(bufferedReader, dataParadoxMsisdnList, dataParadoxList, msisdn);
                    case "nat_data_walle":
                        addArrayList(bufferedReader, dataWalleMsisdnList, dataWalleList, msisdn);
                    case "int_voice_data":
                        addArrayList(bufferedReader, intVoiceDataMsisdnList, intVoiceDataList, msisdn);
                    case "int_sms":
                        addArrayList(bufferedReader, intSmsMsisdnList, intSmsList, msisdn);
                    case "int_mms":
                        addArrayList(bufferedReader, intMmsMsisdnList, intMmsList, msisdn);
                    case "roam_voice":
                        addArrayList(bufferedReader, roamVoiceMsisdnList, roamVoiceList, msisdn);
                    case "roam_sms":
                        addArrayList(bufferedReader, roamSmsMsisdnList, roamSmsList, msisdn);
                    case "roam_data":
                        addArrayList(bufferedReader, roamDataMsisdnList, roamDataList, msisdn);
                }
            ...
            while (cellitr.hasNext()) {
                ...
                switch (celldata.getColumnIndex()) {
                    ...
                    case 29: //Roaming Voice Usage
                        ...
                        break;
                    case 30: //Roaming Voice Country Code
                        try {
                        ...
                        break;
                    case 31: //Roaming Sms Called MSISDN
                        try {
                    ...
                    case 32: //Roaming Sms Usage
                        ...
                        break;
                    case 33: //Roaming Sms MO MT MSC Code
                        try {
                    ...
                    case 34: //Roaming Data Usage
                        ...
                        break;
                    case 35: //Roaming Data MCCMNC Code
                        try {
