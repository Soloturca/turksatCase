...
/*
    @Then("I need to verify {string} element at index {int} matches from Excel")
    public boolean verifyDataFromExcel(String element, int index) {
        String excelData = ReadCellData(1, 2);
        System.out.println(excelData);

        String pageData = commonLib.getTheItemValueFromAttribute(element, index);
        System.out.println(pageData);
        boolean flag = false;

        try {

            if (pageData.equals(excelData)) {
                System.out.println("The excel value:" + excelData + "is match with the element text " + pageData);
                ...
                reportResult("PASS", "The excel value:" + excelData + "is match with the element text " + pageData, true);
            }
            return true;
        } catch (Exception e) {
            System.out.println("The excel value:" + excelData + "is not match with the element text " + pageData);
            ...
            reportResult("FAIL", "The excel value:" + excelData + "is not match with the element text " + pageData, true);
